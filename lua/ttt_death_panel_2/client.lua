...
-- dumb workaround since you can't get these strings with language.GetPhrase
do
    ...
    elseif b1 == 0xFE and b2 == 0xFF then
        -- utf-16 be bom
        be = true
    elseif b1 == 0xEF and b2 == 0xBB and f:ReadByte() == 0xBF then
        -- utf-8 bom
        str = f:Read(f:Size())
        goto isutf8
    elseif b1 == 0x22 and b2 == 0 then
        -- utf-16 le
        f:Seek(0)
        be = false
    elseif b1 == 0 and b2 == 0x22 then
        -- utf-16 be
        f:Seek(0)
        be = true
    elseif b1 == 0x22 and b2 ~= 0 then
